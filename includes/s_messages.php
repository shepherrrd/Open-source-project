...
if (isset($_SESSION['log']) && $_SESSION['log'] == 2){
		...
		case "open_msg" : {
			...
			if (mysql_num_rows($select_un_msg) == 1) {
				...
				$destinataires_app = html_ent(mysql_result($select_un_msg,0,13));
					...
					if ($id_emetteur_app != $id_user_session)
						echo "<td align=\"center\"><a href=\"?s_messages&do=reply&id_msg=".$id_msg."\"><img border=\"0\" src=\"images/others/reply.png\" width=\"50\" height=\"50\" /></a><br /><a href=\"?s_messages&do=reply&id_msg=".$id_msg."\"><b>".reply."</b></a> - </td>";
					
					echo "<td align=\"center\"><a href=\"?s_messages&do=forward&id_msg=".$id_msg."\"><img border=\"0\" src=\"images/others/forward.png\" width=\"50\" height=\"50\" /></a><br /><a href=\"?s_messages&do=forward&id_msg=".$id_msg."\"><b>".forward."</b></a> - </td>";
					
					if ($id_emetteur_app != $id_user_session)
						echo "<td align=\"center\"><a href=\"#\" onClick=\"confirmer('?s_messages&do=delete_msg&id_msg=".$id_msg."&key=".$key."','".confirm_supprimer_msg."')\" title=\"".supprimer."\"><img border=\"0\" src=\"images/icones/delete.png\" width=\"50\" height=\"50\" /></a><br /><a href=\"#\" onClick=\"confirmer('?s_messages&do=delete_msg&id_msg=".$id_msg."&key=".$key."','".confirm_supprimer_msg."')\" title=\"".supprimer."\"><b>".supprimer."</b></a></td>";
					else
						echo "<td align=\"center\"><a href=\"#\" onClick=\"confirmer('?s_messages&do=delete_outbox_msg&id_msg=".$id_msg."&key=".$key."','".confirm_supprimer_msg."')\" title=\"".supprimer."\"><img border=\"0\" src=\"images/icones/delete.png\" width=\"50\" height=\"50\" /></a><br /><a href=\"#\" onClick=\"confirmer('?s_messages&do=delete_outbox_msg&id_msg=".$id_msg."&key=".$key."','".confirm_supprimer_msg."')\" title=\"".supprimer."\"><b>".supprimer."</b></a></td>";
			...
			} else locationhref_admin("?s_messages");
		} break;
		...
		case "new_msg" : {
    	 ...
    	 if (!isset($_SESSION['random_key']) || $_SESSION['random_key'] != $_POST['random']){
    		...
    		$select_apprenants = mysql_query("select id_apprenant, id_classe, identifiant_apprenant from `" . $tblprefix . "apprenants` where id_apprenant != $id_user_session order by id_classe desc;");
    			...
    			} else goback(aucun_destinataire,2,"critical",0);
    	}
		} break;
	...
	if (isset($_GET['l']) && ctype_digit($_GET['l']))
		$page = intval($_GET['l']);
   		...
   		echo "<table border=\"0\" width=\"100%\" align=\"center\"><tr><td align=\"right\"><a href=\"?s_messages&do=new_msg\"><img border=\"0\" src=\"images/others/add.png\" /></a></td>";
   		echo "<td align=\"left\"><a href=\"?s_messages&do=new_msg\"><b>".new_msg."</b></a></td></tr></table>";
   		echo "</td><td align=\"center\" width=\"34%\"><a href=\"?s_messages\"><b>".inbox."</b></a></td>";
  ...
  if ($nbr_trouve > 0){
		...
		$select_msg_limit = mysql_query("select * from `" . $tblprefix . "messages` where id_emetteur_app = $id_user_session and deleted_from_outbox = '0' order by date_message desc limit $limit, $nbr_resultats;"); 
				...
				while($msg = mysql_fetch_row($select_msg_limit)){
					...
					echo "\n<td class=\"affichage_table\" width=\"40%\"><a href=\"?s_messages&do=open_msg&id_msg=".$id_msg."\" title=\"".ouvrir_msg."\"><b>".$titre_msg."</b></a></td>";
    			...
    			echo "</b></td>";
					...
					echo "\n<td class=\"affichage_table\"><a href=\"?s_messages&do=forward&id_msg=".$id_msg."\" title=\"".forward."\"><img border=\"0\" src=\"images/others/forward.png\" width=\"32\" height=\"32\" /></a></td>";
					echo "\n<td class=\"affichage_table\"><a href=\"#\" onClick=\"confirmer('?s_messages&do=delete_outbox_msg&id_msg=".$id_msg."&key=".$key."','".confirm_supprimer_msg."')\" title=\"".supprimer."\"><img border=\"0\" src=\"images/others/delete.png\" width=\"32\" height=\"32\" /></a></td>";
		...
		if ($page_max > 1){
  		...
  		echo "<br /><table border=\"0\" align=\"center\"><tr>";
			if ($page_precedente >= 1)
				echo "<td><a href=\"?s_messages&do=outbox&l=".$page_precedente."\"><img border=\"0\" src=\"images/others/precedent.png\" width=\"32\" height=\"32\" /></a></td><td><a href=\"?s_messages&do=outbox&l=".$page_precedente."\"><b>".page_precedente."</b></a></td>";
			echo "<td>";
			for($i=1;$i<=$page_max;$i++){
				if ($i != $page) echo "<a href=\"?s_messages&do=outbox&l=".$i."\">";
				echo "<b>".$i."</b>";
				if ($i != $page) echo "</a>";
				echo "&nbsp; ";
			}
			...
			if ($page_suivante <= $page_max)
				echo "<td><a href=\"?s_messages&do=outbox&l=".$page_suivante."\"><b>".page_suivante."</b></a></td><td><a href=\"?s_messages&do=outbox&l=".$page_suivante."\"><img border=\"0\" src=\"images/others/suivant.png\" width=\"32\" height=\"32\" /></a></td>";
			echo "</tr></table>";
		}
  ...
  // ****************** liste_msg **************************	
	...
	if (isset($_GET['l']) && ctype_digit($_GET['l']))
		$page = intval($_GET['l']);
   		...
   		echo "<td align=\"center\" width=\"33%\"><a href=\"?s_messages&do=outbox\"><b>".outbox."</b></a></td>";
   		echo "</tr></table><hr />";
  ...
  if ($nbr_trouve > 0){
		...
		if ($page <= $page_max && $page > 1 && $page_max > 1)
			...
			$select_msg_limit = mysql_query("select * from `" . $tblprefix . "messages` where id_destinataires_app like '%-$id_user_session-%' order by date_message desc limit $limit, $nbr_resultats;"); 
				...
				while($msg = mysql_fetch_row($select_msg_limit)){
					...
					$date_msg = set_date($dateformat,$msg[11]);
					$lu_message_app = $msg[10];
					
					if (strpos($lu_message_app,"-".$id_user_session."-") !== false)
						echo "<tr bgcolor=\"#cccccc\">\n";
					else echo "<tr>\n";
	
					echo "\n<td class=\"affichage_table\" width=\"50%\"><a href=\"?s_messages&do=open_msg&id_msg=".$id_msg."\" title=\"".ouvrir_msg."\"><b>".$titre_msg."</b></a></td>";
					...
					echo "\n<td class=\"affichage_table\"><a href=\"?s_messages&do=reply&id_msg=".$id_msg."\" title=\"".reply."\"><img border=\"0\" src=\"images/others/reply.png\" width=\"32\" height=\"32\" /></a></td>";
					echo "\n<td class=\"affichage_table\"><a href=\"?s_messages&do=forward&id_msg=".$id_msg."\" title=\"".forward."\"><img border=\"0\" src=\"images/others/forward.png\" width=\"32\" height=\"32\" /></a></td>";
					echo "\n<td class=\"affichage_table\"><a href=\"#\" onClick=\"confirmer('?s_messages&do=delete_msg&id_msg=".$id_msg."&key=".$key."','".confirm_supprimer_msg."')\" title=\"".supprimer."\"><img border=\"0\" src=\"images/others/delete.png\" width=\"32\" height=\"32\" /></a></td>";
		...
		if ($page_max > 1){
  		...
  		echo "<br /><table border=\"0\" align=\"center\"><tr>";
			if ($page_precedente >= 1)
				echo "<td><a href=\"?s_messagess&l=".$page_precedente."\"><img border=\"0\" src=\"images/others/precedent.png\" width=\"32\" height=\"32\" /></a></td><td><a href=\"?s_messages&l=".$page_precedente."\"><b>".page_precedente."</b></a></td>";
			echo "<td>";
			for($i=1;$i<=$page_max;$i++){
				if ($i != $page) echo "<a href=\"?s_messages&l=".$i."\">";
				echo "<b>".$i."</b>";
				if ($i != $page) echo "</a>";
				echo "&nbsp; ";
			}
			echo "</td>";
			if ($page_suivante <= $page_max)
				echo "<td><a href=\"?s_messages&l=".$page_suivante."\"><b>".page_suivante."</b></a></td><td><a href=\"?s_messages&l=".$page_suivante."\"><img border=\"0\" src=\"images/others/suivant.png\" width=\"32\" height=\"32\" /></a></td>";
			echo "</tr></table>";
		}
			} else echo aucun_message;
		}
