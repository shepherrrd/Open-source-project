...
function CheckAuthentication()
{
	...
	$chars = array('/', '\\', ' ', '-', '.', ',');
	$code0sess = substr($_SERVER['PHP_SELF'],0,strrpos($_SERVER['PHP_SELF'],'/jscripts')+1);
	...
	if($_SESSION['IsAuthorized'] == 1) { return true ; }
	else { return false; }
}
...
$realpath_ckfinder = $_SERVER['PHP_SELF'];
$realpath_ckfinder2 = substr($realpath_ckfinder,0,strrpos($realpath_ckfinder,'/jscripts'))."/docs/";

$baseUrl = $realpath_ckfinder2;
