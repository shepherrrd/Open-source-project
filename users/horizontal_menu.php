		  ...
		  function check_menu($type,$notre_menu,$value){
    		...
    		if (mysqli_num_rows($select_article) > 0){
    			...
    			while($article = mysql_fetch_row($select_article)){
    				...
    				if ($type_hormenu == "article" && $id_menu_article == $id_menu)
    		...
    		echo "\n<b><input name=\"menu_contenu\" type=\"radio\" value=\"lien\"".check_menu('url',$type_hormenu,1)." onclick=\"DisplayHide('contenu_menu', 'contenu2')\"> " .lien. " : </b>";
    		echo "\n<div style=\"display: ".check_menu('url',$type_hormenu,0)."; margin-left: 20px;\" class=\"contenu_menu\" id=\"contenu2\">";
    		echo "<br />- ".remarque_lien_interne." :<br /><ul>";
    		echo "<li><u>".tutoriels2."</u> : <b>?tutorial=1</b></li>";
    		echo "<li><u>".contact_us."</u> : <b>?contact</b></li>";
    		echo "<li><u>".document_sharing."</u> : <b>?documents</b></li>";
    		...
    		if($dir = opendir("../modules")){
    			echo "\n<b><input name=\"menu_contenu\" type=\"radio\" value=\"module\"".check_menu('module',$type_hormenu,1)." onclick=\"DisplayHide('contenu_menu', 'contenu3')\"> " .module. " : </b>";
    			echo "\n<div style=\"display: ".check_menu('module',$type_hormenu,0)."; margin-left: 20px;\" class=\"contenu_menu\" id=\"contenu3\">";
    			echo "\n<br />".remarque_module."<br />";
    			while($file = readdir($dir)) {
						if ($file != "." && $file != ".." && substr($file,-4,1) != "." && substr($file,-5,1) != ".") {
							echo "\n<br /><b><input name=\"modules\" type=\"radio\" value=\"".$file."\"";
							if ($type_hormenu == "module" &&  $file == $lien_hormenu)
	...
	// ****************** desactiver_menu **************************
   	...
   	// ****************** liste_menu **************************
		default : {
			...
			echo "<table border=\"0\"><tr><td><a href=\"?inc=horizontal_menu&do=add_menu\"><img border=\"0\" src=\"../images/others/add.png\" /></a></td><td><a href=\"?inc=horizontal_menu&do=add_menu\"><b>".ajouter_menu."</b></a></td></tr></table><br />";
  		...
  		if ($nbr_trouve > 0){
				...
				if ($type_menu == "article"){
					...
					echo "</td>";
					echo "\n<td class=\"affichage_table\"><a href=\"?inc=horizontal_menu&do=edit_menu&id_menu=".$id_menu."\" title=\"".editer."\"><img border=\"0\" src=\"../images/others/edit.png\" width=\"32\" height=\"32\" /></a></td>";
					...
					if ($active_menu == 1)
						echo "\n<td class=\"affichage_table\"><a href=\"?inc=horizontal_menu&do=desactiver_menu&id_menu=".$id_menu."&key=".$key."\"><b>".desactiver."</b></a></td>";
					else
						echo "\n<td class=\"affichage_table\"><a href=\"?inc=horizontal_menu&do=activer_menu&id_menu=".$id_menu."&key=".$key."\"><b>".activer."</b></a></td>";
		...
		if ($page_max > 1){
  		...
  		echo "<br /><table border=\"0\" align=\"center\"><tr>";
			if ($page_precedente >= 1)
				echo "<td><a href=\"?inc=horizontal_menu&l=".$page_precedente."\"><img border=\"0\" src=\"../images/others/precedent.png\" width=\"32\" height=\"32\" /></a></td><td><a href=\"?inc=horizontal_menu&l=".$page_precedente."\"><b>".page_precedente."</b></a></td>";
			echo "<td>";
			for($i=1;$i<=$page_max;$i++){
				if ($i != $page) echo "<a href=\"?inc=horizontal_menu&l=".$i."\">";
				echo "<b>".$i."</b>";
				if ($i != $page) echo "</a>";
				echo "&nbsp; ";
			}
			...
			if ($page_suivante <= $page_max)
				echo "<td><a href=\"?inc=horizontal_menu&l=".$page_suivante."\"><b>".page_suivante."</b></a></td><td><a href=\"?inc=horizontal_menu&l=".$page_suivante."\"><img border=\"0\" src=\"../images/others/suivant.png\" width=\"32\" height=\"32\" /></a></td>";
			echo "</tr></table>";
		}
